...
class TeamsNotifier:
    ...
    Uses the simple ``text`` payload format compatible with both legacy
    Office 365 connectors and the newer Workflows-based webhooks.
    ...
    def send(self, title: str, body: str, *, severity: str = "info") -> bool:
        ...
        if not self.webhook_url:
            logger.warning("Teams webhook_url not configured")
            return False
